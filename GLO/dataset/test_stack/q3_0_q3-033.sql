...
a1.site_id = t1.site_id and
a1.site_id = tq1.site_id and
...
t2.site_id = q2.site_id and
u2.site_id = t2.site_id and
u2.site_id = tq2.site_id and


-- intersect
u1.account_id = u2.account_id and
account.id = u1.account_id and
account.id = u2.account_id;
